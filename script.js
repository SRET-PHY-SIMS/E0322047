...
let cannonSfx = new
Audio("https://ia601404.us.archive.org/24/items/metal-block/Anti%20Aircraft%20Cannon-18363-Free-Loops.com.mp3");
...
this.friction = 0.008;
this.collAudio = new
Audio("https://archive.org/download/metal-block_202104/metal-block.wav");
...
if(ball.x + ball.radius > 580) {
//We set the X & Y coordinates first to prevent ball from getting stuck in the canvas
border
